...
#========================================================================================
RUTA_GUARDADO = "/ruta/deseada/DST_GAMONAL_SWP.png"  # Especifica la ruta completa aquí
#========================================================================================
...
# Bucle que ejecuta update_data cada hora
while True:
    try:
        update_data()  # Llama a la función principal
    except Exception as e:
